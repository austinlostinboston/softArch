...
public class HumidityController
{
	public static void main(String args[])
	{
		...
		int ComponentId = 35;				// An id used to identify this as a console to the service maintenance console
		String ServeMaintName = "Humidity";		// A name to display in the Service Maintenance Console
		String ServeMaintDesc = "Keeps humidity inside threshold."; // Description
